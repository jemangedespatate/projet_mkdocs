...
const CLASSES = ["2A", "2B", "2C", "2D"];

// Clé localStorage pour mémoriser le choix de l'élève
const STORAGE_KEY = "snt_classe_choisie";

// ────────────────────────────────────────────────────────────
// 📅 ÉVÉNEMENTS
//
// "all"    → commun à toutes les classes
// "2A"     → spécifique à la classe 2A (adapter selon CLASSES)
//
...
const EVENTS = {
  "all": {
    "2026-09-08": [
      { type: "cours", title: "Introduction SNT", description: "Présentation du programme et de l'année scolaire" }
    ],
    "2026-09-15": [
      { type: "tp", title: "TP Python n°1", description: "Prise en main de Thonny et premières instructions" }
    ]
  },
  "2A": {
    "2026-09-10": [
      { type: "devoir", title: "Exercices variables", description: "Fiche p.3-4 à rendre vendredi" }
    ]
  },
  "2B": {
    // Ajoutez les événements spécifiques à 2B ici
  },
  "2C": {
    // Ajoutez les événements spécifiques à 2C ici
  },
  "2D": {
    // Ajoutez les événements spécifiques à 2D ici
  }
};
...
// ── Fusion des événements (all + classe) ─────────────────────

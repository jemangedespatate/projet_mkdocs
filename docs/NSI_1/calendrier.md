...
const CLASSES = ["NSI Groupe 1", "NSI Groupe 2"];

// Clé localStorage pour mémoriser le choix de l'élève
const STORAGE_KEY = "nsi1_classe_choisie";

// ────────────────────────────────────────────────────────────
// 📅 ÉVÉNEMENTS
//
// "all"  → commun à toutes les classes
// "1A"   → spécifique à la classe 1A (adapter selon CLASSES)
//
...
const EVENTS = {
  "all": {
    "2026-09-08": [
      { type: "cours", title: "Introduction NSI", description: "Présentation du programme, notion d'algorithme" }
    ],
    "2026-09-15": [
      { type: "tp", title: "TP Python n°1", description: "Variables, types, affectation — Thonny" }
    ]
  },
  "1A": {
    // Ajoutez les événements spécifiques à 1A ici
  },
  "1B": {
    // Ajoutez les événements spécifiques à 1B ici
  },
  "1C": {
    // Ajoutez les événements spécifiques à 1C ici
  }
};

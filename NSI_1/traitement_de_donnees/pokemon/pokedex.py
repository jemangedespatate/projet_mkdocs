...
# ==========================================================
# PARTIE À COMPLÉTER PAR LES ÉLÈVES
# ==========================================================

def charger_pokemons(nom_fichier):
    """
    Charge les données du fichier CSV et retourne une liste de dictionnaires.
    Chaque dictionnaire représente un Pokémon avec ses stats converties en int.
    """
    pokemons = []
    try:
...
def rechercher_pokemon(nom_recherche, table):
    ...
    Retourne le dictionnaire du Pokémon trouvé ou None.
    """
    # Écris ton code ici pour parcourir la table
    pass
...
def calculer_moyenne_vitesse(table):
    """
    Calcule la vitesse moyenne de tous les Pokémon de la table.
    """
    # Écris ton code ici
    pass
...
def filtrer_par_type(type_recherche, table):
    """
    Retourne une liste de noms de Pokémon appartenant au type demandé.
    """
    # Écris ton code ici
    pass

# ==========================================================
# PARTIE INTERFACE (NE PAS MODIFIER)
# ==========================================================
...
fenetre = tk.Tk()
fenetre.title("Mon Pokédex NSI")
fenetre.geometry("450x450")
fenetre.configure(bg="#f4f4f4")

tk.Label(fenetre, text="🔴 Pokédex Kanto", font=("Helvetica", 18, "bold"), bg="#f4f4f4", fg="#e3350d").pack(pady=15)
...
def afficher_bonus_moyenne():
    ...
    if moy is not None:
        ...
        messagebox.showwarning("Bonus", "Fonction non prête.")
